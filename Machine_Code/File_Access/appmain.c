...
void show_screen(int tag)
{
    ...
    switch(tag)
    {
        case 0:
            emKM = eMain;
            CTOS_LCDTPrintXY(1, 1, "\fr FILETYPE SYSTEM \fn");
        ...
        case 1:
            ...
            break;
        case 2:
            CTOS_LCDTPrintXY(1, 1, "\fr DELETE FILETYPE \fn");
            break;
        case 3: 
            CTOS_LCDTPrintXY(1, 1, "\fr DIRETCORY \fn");
            break;
        case 4:
            CTOS_LCDTPrintXY(1, 1, "\fr WRITE FILETYPE \fn");
            break;
        case 5:
            CTOS_LCDTPrintXY(1, 1, "\fr READ FILETYPE \fn");
            break;
        case 6:
            CTOS_LCDTPrintXY(1, 1, "\fr RENAME FILETYPE \fn");
            break;
        case 7:
            emKM = eMainPage2;
            CTOS_LCDTPrintXY(1, 1, "\fr FILETYPE SYSTEM \fn");
 ...
 * NOTES:         none.                                              
 * ================================================================ */     
USHORT NewFile(BYTE *pbaFileName, BYTE bStorageType,BYTE bAttrib)
{
...
CTOS_LCDTClearDisplay (); 
  ...
  CTOS_LCDTPrint("      Attribute Directory     \n");
            ...
            case eMain:
                switch(key)
                {
                    case d_KBD_1:   //Run 'NewFile' Function
                        ...
                        switch(key)
                        {
                            case d_KBD_1: //Flash
                                ...
                                ret = NewFile(babuff , 0,d_FA_PUBLIC);
                                if (ret == d_OK)
                    ...
                    case d_KBD_CANCEL:  //Exit Application                        
                        exit(0);
                    case d_KBD_DOT:   //Go to next page
                        show_screen(7);
                        emKM=eMainPage2;
                        break;
                }
            ...
            case eMainPage2: 
                switch(key)
                {
                    ...
                    case d_KBD_4:   //Run 'FileDirAttrib' Function
                        ...
                        ulBuffLen=d_BUFF_SIZE;
                        packingFilesInfo(stFA,usFileNo,babuff,&ulBuffLen);
                        show_screen(7);
                        break;
                    ...
                    case d_KBD_6: //Run 'Get Disk Free Size' Function
                        ...
                        show_screen(7);
                        break;
                    case d_KBD_0: //Go back Main Page
                        show_screen(0);
                        emKM=eMain;
                        break;
                    case d_KBD_CANCEL: //Exit Application                        
